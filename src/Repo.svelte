        ...
        <div style="font-size: 14px; color: #586069; display: flex;">
            {#if project.language}
                <div style="margin-right: 16px;">
                    <span style="width: 14px; height: 14px; border-radius: 100%; background-color: { project.language ? colors[project.language]?.color : 'gray' }; display: inline-block; top: 1px; position: relative;"></span>
